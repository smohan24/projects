...
<li><a class="menu selected" href="#">MENU</a></li>
<li><a class="menu" href="#">LOCATION</a></li>
<li><a class="menu" href="#">CALL US</a></li>
<li><a class="menu" href="#">ADS</a></li>
<li><a class="menu" href="#">FEEDBACK</a></li>
</ul>

<a href="page5.html">
<img  class="i1" border="0" src="HTMLLAB/back.png" alt="HTML tutorial" width="60" height="60" style="position:absolute; left:85px; top:310px;" ></a>

<div class="v1">
<embed src="HTMLLAB/a_Copy.avi" width=600 height=400 autoplay="TRUE">
 </div>


<a href="page2.html">
<img  class="i1" border="0" src="HTMLLAB/forward.png" alt="HTML tutorial" width="60" height="60" style="position:absolute; left:815px; top:310px;" ></a>

<a href="page1.html">
<img  class="i1" border="0" src="HTMLLAB/g.jpg" alt="HTML tutorial" width="90" height="80" style="position:absolute; right:250px; top:50px;" ></a>


<a href="page2.html">
<img  class="i1" border="0" src="HTMLLAB/h.jpg" alt="HTML tutorial" width="90" height="80" style="position:absolute; right:250px; top:150px;" ></a>

<a href="page3.html">
<img  class="i1" border="0" src="HTMLLAB/i.jpg" alt="HTML tutorial" width="90" height="80" style="position:absolute; right:250px; top:250px;" ></a>

<a href="page4.html">
<img  class="i1" border="0" src="HTMLLAB/j.jpg" alt="HTML tutorial" width="90" height="80" style="position:absolute; right:250px; top:350px;" ></a>

<a href="page5.html">
<img  class="i1" border="0" src="HTMLLAB/k.jpg" alt="HTML tutorial" width="90" height="80" style="position:absolute; right:250px; top:450px;" ></a>

<div style="position: absolute; right: 45px; top: 75px;">
<span style="font-family:calibri;font-size:13pt; color:black;">Butterscotch Mousse Cake</span>
</div>

<div style="position: absolute; right: 100px; top: 175px;">
...
<div style="position: absolute; right: 145px; top: 375px;">
<span style="font-family:calibri;font-size:13pt; color:black;">Pizza Mania</span>
</div>

<div style="position: absolute; right: 100px; top: 475px;">
