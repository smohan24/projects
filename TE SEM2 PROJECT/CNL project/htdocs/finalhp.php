...
<table border=0 align=center>
	<tr><td valign=top>
	<td width=15> </td>
	<img id=0 class="normal" src="" width=400 height=300>
	</tr><br>
<tr>
<td>	<a href="finalhp1.php"> <img src="back.png" border="0" width=20 height=20> </a> </td>
<td>	<img id=1 class="normal" src="3.jpg" width=110 alt="Margherita Pizza" onmousemove="SelectImage(1)"></td>
<td>	<img id=2 class="normal" src="2.jpg" width=110 alt="Cheese & Tomato" onmousemove="SelectImage(2)"></td>
<td>	<img id=3 class="normal" src="7.jpg" width=110 alt="Peppy Panner" onmousemove="SelectImage(3)"></td>
