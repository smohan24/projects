...
<div class="veg">SIMPLY VEG</div><br>
	...
	<a class="thumbnail" href="#"  onClick="MessageBoard('Cheese And Tomato')">
...
<div class="veg">VEG TREAT</div><br>
	...
	<a class="thumbnail" href="#" onClick="MessageBoard('Double Cheese Margherita')">
	...
	<a class="thumbnail" href="#" onClick="MessageBoard('Fresh Veggie')">
	...
	<a class="thumbnail" href="#" onClick="MessageBoard('Country Special')">
	...
	<a class="thumbnail" href="#" onClick="MessageBoard('Farm House')">
...
<div class="veg">VEG SPECIAL</div><br>
	...
	<a class="thumbnail" href="#" onClick="MessageBoard('Peppy Paneer')">
	<div class="submenu_veg">Peppy Paneer</div>
	<span><img src="pictures\7.jpg" width=390 height=320/>
	<br/><div class="caption">Peppy Paneer</div>
	</span></a>

	<a class="thumbnail" href="#" onClick="MessageBoard('Mexican Green Wave')">
	...
	<a class="thumbnail" href="#" onClick="MessageBoard('Deluxe Veggie')">
...
<div class="veg">FEAST PIZZA</div><br>
	...
	<a class="thumbnail" href="#" onClick="MessageBoard('Veg Extravaganza')">
