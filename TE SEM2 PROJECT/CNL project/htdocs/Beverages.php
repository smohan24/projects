...
function MessageBoard(bev)
{
window.open("cart_bev.php?name1="+bev,"no","height=440,width= 400")
}
</Script>
...
<br>
<div class="margin"><font face="arial" color="#FF0000">Home >> Menu >> Beverages</font></div>
<div class="margin1">
...
<span><img class="v2" src="pictures\42.jpg" width=390 height=320/></span>

<div class="margin">
<div class="gallerycontainer">
<b>
<br>
<div class="veg">BEVERAGES</div><br>
	
	<a class="thumbnail" href="#" onClick="MessageBoard('Coke')">
	<div class="submenu_veg">Coke</div>
	<span><img src="pictures\42.jpg" width=390 height=320/>
	<br/><div class="caption">Coke</div>
	</span></a>

	<a class="thumbnail" href="#" onClick="MessageBoard('Fanta')">
	<div class="submenu_veg">Fanta</div>
	<span><img src="pictures\43.jpg" width=390 height=320/>
	<br/><div class="caption">Fanta</div>
	</span></a>

	<a class="thumbnail" href="#" onClick="MessageBoard('Sprite')">
	<div class="submenu_veg">Sprite</div>
	<span><img src="pictures\44.jpg" width=390 height=320/>
	<br/><div class="caption">Sprite</div>
	</span></a>
	<br>
...
<a href="viewcart.php">
<img border="0" src="cart.jpg" alt="View Cart" style="position:absolute; left:820px; top:48px;" width=40 height=40></a>s
</body>
</html>