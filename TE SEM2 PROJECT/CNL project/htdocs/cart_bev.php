...
<title>Adding Beverages to cart</title>
...
if(isset($_POST['add']))
{
 ...
 $sql1=mysql_query("Select * from pizza_db where pname like '%$bev2%'"); 
 ...
 $sql="Insert into cart values('$bev2',$r[2],'NA',$_POST[qty],'NA','NA',$tot,'$r[3]')";
