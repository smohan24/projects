...
<tr>
<td>	<a href="finalhp1.php"> <img src="back.png" border="0" width=20 height=20> </a> </td>
<td>	<img id=1 class="normal" src="26.jpg" width=110 alt="Spicy Twisty" onmousemove="SelectImage(1)"></td>
<td>	<img id=2 class="normal" src="27.jpg" width=110 alt="Veg Pasta Italiano White" onmousemove="SelectImage(2)"></td>
<td>	<img id=3 class="normal" src="35.jpg" width=110 alt="Choco Lava Cake" onmousemove="SelectImage(3)"></td>
<td>	<a href="finalhp.php"> <img src="forward.png" border="0" width=20 height=20> </a> </td>
</tr>
...
<a href="finalhp.php"><img border="0" id="myPicture1" src="home.jpg" width="70" height="80" onMouseover="zoom_out(100,105,this)" onMouseout="zoom_in(70,70,this)"></a></td>
<td width=5></td>
