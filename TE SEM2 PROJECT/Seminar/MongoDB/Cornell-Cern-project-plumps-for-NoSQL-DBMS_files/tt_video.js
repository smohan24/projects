...
function tbr_show(caption, url, imageGroup) {//function called when the user clicks on a thickbox link
	...
	try {
	 	...
	 	var closeText = (lang == 'es') ? 'Cerrar' : 'Close';
	 	var closeWindowText = (lang == 'es')
	 			? "<a href='#' id='TBR_closeWindowButton' title='Cerrar'>cerrar</a> o tecla Esc"
	 			: "<a href='#' id='TBR_closeWindowButton' title='Close'>close</a> or Esc Key";
