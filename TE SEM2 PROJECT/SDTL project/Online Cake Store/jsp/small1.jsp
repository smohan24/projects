...
<span><img class="v2" src="20.jpg" width=390 height=320/>

<div class="margin"></div>
<div class="gallerycontainer">
<b>
<br>
<div class="veg">Small Bites</div><br>
	
	<a class="thumbnail" href="#" onClick="MessageBoard('Fruit Tart')" STYLE="TEXT-DECORATION: NONE"><div class="submenu_veg">Fruit Tart</div>
	<span><img src="16.jpg" width=390 height=320/>
	<br/><div class="caption">Fruit Tart</div>
	</span></a>
	<br>
	<a class="thumbnail" href="#" onClick="MessageBoard('Apple Tart')" STYLE="TEXT-DECORATION: NONE"><div class="submenu_veg">Apple Tart</div>
	<span><img src="17.jpg" width=390 height=320/>
	<br/><div class="caption">Apple Tart</div>
	</span></a>
	<br>

	<a class="thumbnail" href="#" onClick="MessageBoard('Choco Tart')" STYLE="TEXT-DECORATION: NONE">
	<div class="submenu_veg">Choco Tart</div>
	<span><img src="18.jpg" width=390 height=320/>
	<br/><div class="caption">Choco Tart</div>
	</span></a>
	<br>

	<a class="thumbnail" href="#" onClick="MessageBoard('Choco Donuts')" STYLE="TEXT-DECORATION: NONE"><div class="submenu_veg">Choco Donuts</div>
	<span><img src="19.jpg" width=390 height=320/>
	<br/><div class="caption">Choco Donuts</div>
	</span></a>
	<br>

	<a class="thumbnail" href="#" onClick="MessageBoard('Cupcakes')" STYLE="TEXT-DECORATION: NONE"><div class="submenu_veg">Cupcakes</div>
	<span><img src="24.jpg" width=390 height=320/>
	<br/><div class="caption">Cupcakes</div>
	</span></a>
	<br>

	
	<a class="thumbnail" href="#" onClick="MessageBoard('Chocolate Balls')" STYLE="TEXT-DECORATION: NONE"><div class="submenu_veg">Chocolate Balls</div>
	<span><img src="23.jpg" width=390 height=320/>
	<br/><div class="caption">Chocolate Balls</div>
	</span></a>
	<br>

	<a class="thumbnail" href="#" onClick="MessageBoard('Eclairs')" STYLE="TEXT-DECORATION: NONE"><div class="submenu_veg">Eclairs</div>
	<span><img src="22.jpg" width=390 height=320/>
	<br/><div class="caption">Eclairs</div>
	</span></a>
	<br>
