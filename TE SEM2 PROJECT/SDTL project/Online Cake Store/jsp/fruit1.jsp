...
<span><img class="v2" src="15.jpg" width=390 height=320/>
...
<b>
<br>
<div class="veg">Fruit Cakes</div><br>
	
	<a class="thumbnail" href="#" onClick="MessageBoard('Pineapple Cake')" STYLE="TEXT-DECORATION: NONE"><div class="submenu_veg">Pineapple Cake</div>
	<span><img src="2.jpg" width=390 height=320/>
	<br/><div class="caption">Pineapple Cake</div>
	</span></a>
	<br>
	<a class="thumbnail" href="#" onClick="MessageBoard('Rich Plum Cake')" STYLE="TEXT-DECORATION: NONE"><div class="submenu_veg">Rich Plum Cake</div>
	<span><img src="10.jpg" width=390 height=320/>
	<br/><div class="caption">Rich Plum Cake</div>
	</span></a>
	<br>

	<a class="thumbnail" href="#" onClick="MessageBoard('Fresh Fruit Cake')" STYLE="TEXT-DECORATION: NONE">
	<div class="submenu_veg">Fresh Fruit Cake</div>
	<span><img src="12.jpg" width=390 height=320/>
	<br/><div class="caption">Fresh Fruit Cake</div>
	</span></a>
	<br>

	<a class="thumbnail" href="#" onClick="MessageBoard('Fresh Orange Cake')" STYLE="TEXT-DECORATION: NONE"><div class="submenu_veg">Fresh Orange Cake</div>
	<span><img src="13.jpg" width=390 height=320/>
	<br/><div class="caption">Fresh Orange Cake</div>
	</span></a>
	<br>

	<a class="thumbnail" href="#" onClick="MessageBoard('Fresh Strawberry Cake')" STYLE="TEXT-DECORATION: NONE"><div class="submenu_veg">Fresh Strawberry Cake</div>
	<span><img src="14.jpg" width=390 height=320/>
	<br/><div class="caption">Fresh Strawberry Cake</div>
	</span></a>
	<br>
