...
<span><img class="v2" src="5.jpg" width=390 height=320/>
...
<div class="veg">Chocolate Cakes</div><br>
	...
	<a class="thumbnail" href="#" onClick="MessageBoard('Chocolate Hazelnut')" STYLE="TEXT-DECORATION: NONE"><div class="submenu_veg">Chocolate Hazelnut</div>
	<span><img src="1.jpg" width=390 height=320/>
	<br/><div class="caption">Chocolate Hazelnut</div>
	</span></a>
	<br>
	<a class="thumbnail" href="#" onClick="MessageBoard('Choco Strawberry Truffle')" STYLE="TEXT-DECORATION: NONE"><div class="submenu_veg">Choco Strawberry Truffle</div>
	<span><img src="3.jpg" width=390 height=320/>
	<br/><div class="caption">Choco Strawberry Truffle</div>
	</span></a>
	<br>

	<a class="thumbnail" href="#" onClick="MessageBoard('Rich Chocolate Truffle')" STYLE="TEXT-DECORATION: NONE">
	...
	<a class="thumbnail" href="#" onClick="MessageBoard('Black Forest')" STYLE="TEXT-DECORATION: NONE"><div class="submenu_veg">Black Forest</div>
	<span><img src="5.jpg" width=390 height=320/>
	<br/><div class="caption">Black Forest</div>
	</span></a>
	<br>

	<a class="thumbnail" href="#" onClick="MessageBoard('Chocolate Mint')" STYLE="TEXT-DECORATION: NONE"><div class="submenu_veg">Chocolate Mint</div>
	...
	<a class="thumbnail" href="#" onClick="MessageBoard('Chocolate Walnut')" STYLE="TEXT-DECORATION: NONE"><div class="submenu_veg">Chocolate Walnut</div>
	<span><img src="7.jpg" width=390 height=320/>
	<br/><div class="caption">Chocolate Walnut</div>
	</span></a>
	<br>

	<a class="thumbnail" href="#" onClick="MessageBoard('Chocolate Almond')" STYLE="TEXT-DECORATION: NONE">
	...
	<a class="thumbnail" href="#" onClick="MessageBoard('Choco Chip Cake')" STYLE="TEXT-DECORATION: NONE"><div class="submenu_veg">Choco Chip Cake</div>
	<span><img src="9.jpg" width=390 height=320/>
	<br/><div class="caption">Choco Chip Cake</div>
	</span></a>
	<br>
	<a class="thumbnail" href="#" onClick="MessageBoard('Chocolate Marble Cake')" STYLE="TEXT-DECORATION: NONE"><div class="submenu_veg">Chocolate Marble Cake</div>
