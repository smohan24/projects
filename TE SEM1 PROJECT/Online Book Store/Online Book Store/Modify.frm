...
Private Sub lbl_update_Click()
    If (txt_bkname = "") Then
        MsgBox "Enter the name of the book !", , "Error"
    Else
        cn.Execute "update books set price='" + txt_unitp.Text + "'where bookname='" + txt_bkname.Text + "'"
        cn.Execute "update books set discount='" + txt_discount.Text + "'where bookname='" + txt_bkname.Text + "'"
        cn.Execute "update books set copies='" + txt_copies.Text + "' where bookname='" + txt_bkname.Text + "'"
